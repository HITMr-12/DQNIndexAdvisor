...
class Env:
    def __init__(self, workload, candidates, mode, a):
        ...
        self._frequencies = np.random.randint(10,size=21)
        ...
        self.init_cost = np.array(self.pg_client1.get_queries_cost(workload))
        ...
        self.init_state = np.zeros((len(candidates),), dtype=np.float)
